...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-rule">
      <Container className="grid items-center gap-x-14 gap-y-12 py-16 sm:py-20 lg:grid-cols-[minmax(0,1fr)_minmax(0,30rem)] lg:py-24">
        <div>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            <Link
              ...
              className="rounded-[9px] bg-result px-6 py-3 text-[0.9375rem] font-medium text-paper transition-transform duration-200 ease-quart hover:-translate-y-px hover:shadow-[0_6px_18px_-6px_oklch(0.47_0.185_30/0.5)]"
            >
              {downloadLabel}
            </Link>
            <a
